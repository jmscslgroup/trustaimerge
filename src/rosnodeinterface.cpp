  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"trustaimerge\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(trustaimerge_M, (NULL));
        trustaimerge_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(trustaimerge_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(trustaimerge_M)
                == (NULL)) || rtmGetStopRequested(trustaimerge_M));
    ...
    {
      mRunModel = (rtmGetErrorStatus(trustaimerge_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
